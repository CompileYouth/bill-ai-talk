...
do {
    ...
    drawText("差不多对", rect: NSRect(x: 170, y: 160, width: 860, height: 88), font: .systemFont(ofSize: 80, weight: .heavy), color: dark, align: .center, lineHeight: 92)
    drawText("才最危险", rect: NSRect(x: 170, y: 304, width: 860, height: 88), font: .systemFont(ofSize: 80, weight: .heavy), color: dark, align: .center, lineHeight: 92)
