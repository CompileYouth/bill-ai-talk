...
do {
    ...
    drawText("多开几个窗口", rect: NSRect(x: 120, y: 180, width: 960, height: 70), font: .systemFont(ofSize: 60, weight: .heavy), color: dark, align: .center, lineHeight: 64)
    drawText("不等于把事组织起来", rect: NSRect(x: 120, y: 300, width: 960, height: 70), font: .systemFont(ofSize: 60, weight: .heavy), color: dark, align: .center, lineHeight: 64)
