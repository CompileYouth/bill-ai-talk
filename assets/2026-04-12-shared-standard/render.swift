...
do {
    ...
    drawText("双Agent怎么搭：", rect: NSRect(x: 110, y: 140, width: 980, height: 88), font: .systemFont(ofSize: 74, weight: .heavy), color: dark, align: .center, lineHeight: 82)
    drawText("共用一套标准", rect: NSRect(x: 110, y: 250, width: 980, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 80)
    drawText("各自不同职责", rect: NSRect(x: 110, y: 356, width: 980, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 80)
