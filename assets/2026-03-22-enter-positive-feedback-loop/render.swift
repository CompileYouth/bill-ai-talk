...
do {
    do {
        ...
        drawText("别让 AI", rect: NSRect(x: 140, y: 150, width: 920, height: 64), font: .systemFont(ofSize: 54, weight: .bold), color: dark, align: .center, lineHeight: 62)
        drawText("每次都从零开始", rect: NSRect(x: 80, y: 230, width: 1040, height: 72), font: .systemFont(ofSize: 64, weight: .bold), color: dark, align: .center, lineHeight: 70)
        drawText("让它越用越懂你", rect: NSRect(x: 80, y: 318, width: 1040, height: 88), font: .systemFont(ofSize: 78, weight: .heavy), color: dark, align: .center, lineHeight: 84)
    ...
    do {
        let r = Renderer(width: 1200, height: 620, background: bg)
        rounded(NSRect(x: 78, y: 68, width: 1044, height: 484), radius: 28, fill: .white, stroke: dark, line: 4)
        drawText("真正拉开差距的", rect: NSRect(x: 140, y: 150, width: 920, height: 64), font: .systemFont(ofSize: 50, weight: .bold), color: dark, align: .center, lineHeight: 58)
        drawText("是更早建立起", rect: NSRect(x: 120, y: 230, width: 960, height: 72), font: .systemFont(ofSize: 56, weight: .bold), color: dark, align: .center, lineHeight: 62)
        drawText("正反馈链路", rect: NSRect(x: 120, y: 312, width: 960, height: 88), font: .systemFont(ofSize: 86, weight: .heavy), color: dark, align: .center, lineHeight: 90)
        watermark("@Bill的精神时光屋", rect: NSRect(x: 860, y: 494, width: 190, height: 24), color: muted)
        r.finish()
        try save(r.image, "2")
    }
