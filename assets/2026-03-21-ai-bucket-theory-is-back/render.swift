...
do {
    do {
        ...
        drawText("AI 时代", rect: NSRect(x: 140, y: 150, width: 920, height: 64), font: .systemFont(ofSize: 54, weight: .bold), color: dark, align: .center, lineHeight: 62)
        drawText("木桶理论又回来了", rect: NSRect(x: 120, y: 232, width: 960, height: 88), font: .systemFont(ofSize: 74, weight: .heavy), color: dark, align: .center, lineHeight: 80)
        drawText("但这次短板重新成了必答题", rect: NSRect(x: 120, y: 350, width: 960, height: 68), font: .systemFont(ofSize: 48, weight: .bold), color: dark, align: .center, lineHeight: 58)
    ...
    do {
        let r = Renderer(width: 1200, height: 620, background: bg)
        rounded(NSRect(x: 78, y: 68, width: 1044, height: 484), radius: 28, fill: .white, stroke: dark, line: 4)
        drawText("以前短板靠团队遮住", rect: NSRect(x: 120, y: 150, width: 960, height: 64), font: .systemFont(ofSize: 50, weight: .bold), color: dark, align: .center, lineHeight: 60)
        drawText("现在短板", rect: NSRect(x: 140, y: 232, width: 920, height: 88), font: .systemFont(ofSize: 82, weight: .heavy), color: dark, align: .center, lineHeight: 88)
        drawText("越来越像态度问题", rect: NSRect(x: 140, y: 350, width: 920, height: 68), font: .systemFont(ofSize: 56, weight: .bold), color: dark, align: .center, lineHeight: 62)
        watermark("@Bill的精神时光屋", rect: NSRect(x: 860, y: 494, width: 190, height: 24), color: muted)
        r.finish()
        try save(r.image, "2")
    }
