...
do {
    ...
    drawText("AI 用上了", rect: NSRect(x: 120, y: 156, width: 960, height: 68), font: .systemFont(ofSize: 62, weight: .heavy), color: dark, align: .center, lineHeight: 68)
    drawText("流程没变", rect: NSRect(x: 120, y: 252, width: 960, height: 68), font: .systemFont(ofSize: 62, weight: .heavy), color: dark, align: .center, lineHeight: 68)
    drawText("人更忙了", rect: NSRect(x: 120, y: 348, width: 960, height: 68), font: .systemFont(ofSize: 62, weight: .heavy), color: dark, align: .center, lineHeight: 68)
    ...
    rounded(NSRect(x: 78, y: 68, width: 1044, height: 484), radius: 28, fill: .white, stroke: dark, line: 4)
    drawText("人定目标和标准", rect: NSRect(x: 120, y: 156, width: 960, height: 68), font: .systemFont(ofSize: 52, weight: .heavy), color: dark, align: .center, lineHeight: 58)
    drawText("Agent 连着做", rect: NSRect(x: 120, y: 252, width: 960, height: 68), font: .systemFont(ofSize: 52, weight: .heavy), color: dark, align: .center, lineHeight: 58)
    drawText("系统留住资料、规则、进度", rect: NSRect(x: 120, y: 348, width: 960, height: 68), font: .systemFont(ofSize: 52, weight: .heavy), color: dark, align: .center, lineHeight: 58)
    watermark("@Bill的精神时光屋", rect: NSRect(x: 790, y: 492, width: 260, height: 24), color: muted)
    r2.finish()
