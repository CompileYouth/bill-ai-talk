...
do {
    ...
    drawText("别让 AI 只停留在对话框里", rect: NSRect(x: 120, y: 146, width: 960, height: 60), font: .systemFont(ofSize: 52, weight: .bold), color: dark, align: .center, lineHeight: 56)
    drawText("要让它进入", rect: NSRect(x: 180, y: 242, width: 840, height: 68), font: .systemFont(ofSize: 64, weight: .bold), color: dark, align: .center, lineHeight: 70)
    drawText("你的工作流", rect: NSRect(x: 120, y: 352, width: 960, height: 88), font: .systemFont(ofSize: 90, weight: .heavy), color: dark, align: .center, lineHeight: 92)
