...
do {
    do {
        ...
        drawText("别顺手", rect: NSRect(x: 140, y: 150, width: 920, height: 64), font: .systemFont(ofSize: 58, weight: .bold), color: dark, align: .center, lineHeight: 64)
        drawText("接管 AI 的活", rect: NSRect(x: 100, y: 230, width: 1000, height: 72), font: .systemFont(ofSize: 68, weight: .bold), color: dark, align: .center, lineHeight: 74)
        drawText("这会掐断正反馈", rect: NSRect(x: 80, y: 318, width: 1040, height: 88), font: .systemFont(ofSize: 76, weight: .heavy), color: dark, align: .center, lineHeight: 82)
    ...
    do {
        let r = Renderer(width: 1200, height: 620, background: bg)
        rounded(NSRect(x: 78, y: 68, width: 1044, height: 484), radius: 28, fill: .white, stroke: dark, line: 4)
        drawText("把反馈还给 AI", rect: NSRect(x: 120, y: 150, width: 960, height: 64), font: .systemFont(ofSize: 56, weight: .bold), color: dark, align: .center, lineHeight: 62)
        drawText("它才会", rect: NSRect(x: 140, y: 230, width: 920, height: 72), font: .systemFont(ofSize: 56, weight: .bold), color: dark, align: .center, lineHeight: 62)
        drawText("越用越懂你", rect: NSRect(x: 100, y: 318, width: 1000, height: 88), font: .systemFont(ofSize: 86, weight: .heavy), color: dark, align: .center, lineHeight: 90)
        watermark("@Bill的精神时光屋", rect: NSRect(x: 850, y: 494, width: 200, height: 24), color: muted)
        r.finish()
        try save(r.image, "2")
    }
