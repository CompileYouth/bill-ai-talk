...
do {
    ...
    drawText("生产时间省下了", rect: NSRect(x: 100, y: 176, width: 1000, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 88)
    drawText("治理成本放大了", rect: NSRect(x: 80, y: 320, width: 1040, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 88)
    ...
    rounded(NSRect(x: 78, y: 68, width: 1044, height: 484), radius: 28, fill: .white, stroke: dark, line: 4)
    drawText("生产成本下降了", rect: NSRect(x: 120, y: 176, width: 960, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 88)
    drawText("治理成本上升了", rect: NSRect(x: 90, y: 320, width: 1020, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 88)
    watermark("@Bill的精神时光屋", rect: NSRect(x: 790, y: 492, width: 260, height: 24), color: muted)
    r2.finish()
    try save(r2.image, "2")
} catch {
