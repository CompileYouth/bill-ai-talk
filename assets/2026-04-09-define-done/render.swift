...
do {
    ...
    drawText("后面一直补", rect: NSRect(x: 170, y: 188, width: 860, height: 92), font: .systemFont(ofSize: 84, weight: .heavy), color: dark, align: .center, lineHeight: 92)
    drawText("往往是前面没说清", rect: NSRect(x: 110, y: 320, width: 980, height: 88), font: .systemFont(ofSize: 64, weight: .heavy), color: dark, align: .center, lineHeight: 74)
