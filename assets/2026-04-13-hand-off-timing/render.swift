...
do {
    ...
    drawText("和 AI 协作时", rect: NSRect(x: 150, y: 126, width: 900, height: 72), font: .systemFont(ofSize: 58, weight: .heavy), color: dark, align: .center, lineHeight: 66)
    drawText("该放手时继续放手", rect: NSRect(x: 120, y: 222, width: 960, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 82)
    drawText("该接手时果断接手", rect: NSRect(x: 120, y: 332, width: 960, height: 88), font: .systemFont(ofSize: 72, weight: .heavy), color: dark, align: .center, lineHeight: 82)
