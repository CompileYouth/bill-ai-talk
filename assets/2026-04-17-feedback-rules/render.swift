...
do {
    ...
    drawText("不是每个反馈", rect: NSRect(x: 120, y: 138, width: 960, height: 70), font: .systemFont(ofSize: 58, weight: .heavy), color: dark, align: .center, lineHeight: 64)
    drawText("都该写进 AGENTS.md", rect: NSRect(x: 120, y: 230, width: 960, height: 70), font: .systemFont(ofSize: 58, weight: .heavy), color: dark, align: .center, lineHeight: 64)
    drawText("有些只该留在这次", rect: NSRect(x: 120, y: 322, width: 960, height: 70), font: .systemFont(ofSize: 58, weight: .heavy), color: dark, align: .center, lineHeight: 64)
