...
do {
    ...
    drawText("AGENTS.md 写完以后", rect: NSRect(x: 110, y: 142, width: 980, height: 76), font: .systemFont(ofSize: 56, weight: .heavy), color: dark, align: .center, lineHeight: 64)
    drawText("还得靠反馈", rect: NSRect(x: 110, y: 236, width: 980, height: 82), font: .systemFont(ofSize: 74, weight: .heavy), color: dark, align: .center, lineHeight: 82)
    drawText("把规则越写越对", rect: NSRect(x: 110, y: 336, width: 980, height: 76), font: .systemFont(ofSize: 54, weight: .heavy), color: dark, align: .center, lineHeight: 62)
