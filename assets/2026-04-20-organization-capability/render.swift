...
do {
    ...
    drawText("过去只有团队", rect: NSRect(x: 120, y: 156, width: 960, height: 68), font: .systemFont(ofSize: 56, weight: .heavy), color: dark, align: .center, lineHeight: 62)
    drawText("才有的能力", rect: NSRect(x: 120, y: 252, width: 960, height: 68), font: .systemFont(ofSize: 56, weight: .heavy), color: dark, align: .center, lineHeight: 62)
    drawText("现在普通人也有了", rect: NSRect(x: 120, y: 348, width: 960, height: 68), font: .systemFont(ofSize: 56, weight: .heavy), color: dark, align: .center, lineHeight: 62)
