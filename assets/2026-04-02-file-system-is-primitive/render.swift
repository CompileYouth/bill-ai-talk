...
do {
    ...
    drawText("文件系统", rect: NSRect(x: 150, y: 138, width: 900, height: 80), font: .systemFont(ofSize: 78, weight: .heavy), color: dark, align: .center, lineHeight: 82)
    drawText("不是存储角落", rect: NSRect(x: 150, y: 238, width: 900, height: 60), font: .systemFont(ofSize: 54, weight: .bold), color: dark, align: .center, lineHeight: 58)
    drawText("而是 AI 的工作表面", rect: NSRect(x: 120, y: 332, width: 960, height: 74), font: .systemFont(ofSize: 64, weight: .heavy), color: dark, align: .center, lineHeight: 70)
