...
> TL;DR
>
> 今天判断自己有没有成长，最简单也最残酷的标准，就是看你对 **AI 的理解有没有更深一点，使用 AI 的能力有没有更强一点**。如果这两件事没有变化，很多别的“成长”其实都不太算数。

我现在越来越觉得，判断自己有没有成长，其实只需要看一件事：**你今天对 AI 的理解是不是比昨天更多了一点，你今天使用 AI 的能力是不是比昨天更强了一点。**
...
![今天还能不能算成长，只看你离 AI 有没有更近一点](../assets/2026-03-20-only-ai-growth-counts/1.jpg)
...
![今天最值钱的成长，不是知道更多，而是更会借 AI 放大自己](../assets/2026-03-20-only-ai-growth-counts/2.jpg)
